...
Добавьте `.gitignore`, который мы для вас [приготовили](https://github.com/RT-Vinsent/ajs-homeworks/blob/ajs8/.gitignore).
...
![](https://raw.githubusercontent.com/RT-Vinsent/ajs-homeworks/ajs8/platforms/pic/settings-menu.png)

Выберите пункт меню Developer Settings:

![](https://raw.githubusercontent.com/RT-Vinsent/ajs-homeworks/ajs8/platforms/pic/developer-menu.png)

Выберите пункт меню Personal Access Tokens (1), затем нажмите на кнопку Generate new token (2):

![](https://raw.githubusercontent.com/RT-Vinsent/ajs-homeworks/ajs8/platforms/pic/generate-token.png)

Заполните поле Note (1) и поставьте флажок напротив write:packages (2), остальные все флажки выставятся автоматически:

![](https://raw.githubusercontent.com/RT-Vinsent/ajs-homeworks/ajs8/platforms/pic/token-settings.png)

После чего нажмите на кнопку Generate в самом низу страницы:

![](https://raw.githubusercontent.com/RT-Vinsent/ajs-homeworks/ajs8/platforms/pic/token-generate-button.png)

GitHub запроси у вас пароль для подтверждения:

![](https://raw.githubusercontent.com/RT-Vinsent/ajs-homeworks/ajs8/platforms/pic/github-sudo.png)

После чего вам будет сгенерирован токен. **Важно**: токен будет показан только один раз, поэтому убедитесь, что скопировали его:

![](https://raw.githubusercontent.com/RT-Vinsent/ajs-homeworks/ajs8/platforms/pic/token.png)
...
![](https://raw.githubusercontent.com/RT-Vinsent/ajs-homeworks/ajs8/platforms/pic/publishing.png)
...
![](https://raw.githubusercontent.com/RT-Vinsent/ajs-homeworks/ajs8/platforms/pic/published.png)

Кликните на имени пакета, чтобы посмотреть информацию о нём:

![](https://raw.githubusercontent.com/RT-Vinsent/ajs-homeworks/ajs8/platforms/pic/package-info.png)
...
![](https://raw.githubusercontent.com/RT-Vinsent/ajs-homeworks/ajs8/platforms/pic/dist.png)

Перейдите к файлу index.js (который в каталоге dist) и нажмите на кнопку Raw:

![](https://raw.githubusercontent.com/RT-Vinsent/ajs-homeworks/ajs8/platforms/pic/raw.png)
...
![](https://raw.githubusercontent.com/RT-Vinsent/ajs-homeworks/ajs8/platforms/pic/cdn.png)
...
![](https://raw.githubusercontent.com/RT-Vinsent/ajs-homeworks/ajs8/platforms/pic/jsbin.png)

После чего выберите File -> Save Snapshot:

![](https://raw.githubusercontent.com/RT-Vinsent/ajs-homeworks/ajs8/platforms/pic/snapshot.png)

После этого станет активна кнопка Share (вам нужно скопировать URL):

![](https://raw.githubusercontent.com/RT-Vinsent/ajs-homeworks/ajs8/platforms/pic/share.png)
